...
In the described primal barrier method the gradient and the Hessian of the logarithmic barrier function are necessary. SOCCs in the above mentioned form are not continuously differentiable. Therefor SOCCs in Generalized form \cite{c2} can be used.
\begin{equation}
