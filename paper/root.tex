...
So we aim to cobinate the advantages of existing algorithms to get very fast solutions and use several approaches for robustness of the algorithm.
...
\section{RESULTS}
Comparison of the speed of the algorithm\\
