...
def _copy_simulink_code(prefix):
    ...
    copytree(prefix + '/template/simulink', cmpc_dir + '/simulink')
...
def _copy_fixed_code(prefix, matlab=False):
    ...
    copytree(prefix + subdir + cmpc_dir, cmpc_dir)

    if matlab:
        copytree(prefix + subdir + 'matlab', cmpc_dir + '/matlab')
