...
real_t *u_lb;  /**< The lower bound for the state independent constraints. */
real_t *u_ub;  /**< The upper bound for the state independent constraints. */
...
uint32_t HOR_INPUTS;  /**< The length of the state independent constraints. */
uint32_t HOR_MXCONSTRS;  /**< The length of the state dependent constraints. */
...
struct mpc_sys {
real_t *Ad;  /**< Discrete-time system matrix. */
real_t *Bd;  /**< Discrete-time input matrix. */
real_t *dt;  /**< Discretization time in seconds. */
}; /**< Discrete-time system data. */

struct mpc_wmx {
real_t *Q;  /**< State weighting matrix. */
real_t *R;  /**< Input weighting matrix. */
real_t *P;  /**< Terminal state weighting matrix. */
};  /**< MPC weighting matrices. */

struct mpc_lqr {
real_t *K;  /**< Linear quadratic regulator gain matrix. */
real_t *P;  /**< Terminal state weighting matrix. */
...
real_t *Bh_T;  /**< Extended input matrix (used for reference tracking). */
...
uint32_t HOR;  /**< MPC prediction horizon. */
uint32_t STATES;   /**< Number of system states. */
uint32_t INPUTS;  /**< Number of system inputs. */
uint32_t HOR_INPUTS;  /**< Horizon times number of inputs. */
uint32_t HOR_STATES;  /**< Horizon times number of states. */
...
real_t *Kx_Ai;  /**< Prediction component of the mixed constraint bound. */
real_t *e_lb;  /**< Lower bound for the mixed constraint. */
real_t *e_ub;  /**< Upper bound for the mixed constraint. */
real_t *Linv;  /**< Inverse of gradient Lipschitz constant (1/L). */
uint32_t STATES;   /**< Number of system states. */
uint32_t MXCONSTRS; /**< Number of state constraints. */
uint32_t HOR_INPUTS;  /**< Horizon times number of inputs. */
uint32_t HOR_MXCONSTRS;  /**< Horizon times number of states constraints. */
