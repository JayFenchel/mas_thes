...
struct mpc_conf {
uint32_t in_iter;  /**< Maximun number of internal loop (FGM) iterations (j_in). */
...
const uint32_t HOR_STCONSTRS;  /**< The length of the state dependent constraints. */
...
const real_t *Ad_T;  /**< Discrete-time system matrix transposed. */
const real_t *Bd_T;  /**< Discrete-time input matrix transposed. */
...
const uint32_t STATES;   /**< Number of system states. */
const uint32_t STCONSTRS; /**< Number of state constraints. */
const uint32_t HOR_INPUTS;  /**< Horizon times number of inputs. */
const uint32_t HOR_STCONSTRS;  /**< Horizon times number of states constraints. */
